...
from model.mvn.utils.img import resize_image, crop_image, normalize_image, scale_bbox
...
class Human36MMultiViewDataset(Dataset):
    ...
    def __init__(self,
        ...
        """
            ...
            retain_every_n_frames_in_test: 每隔多少帧，取一帧用于训练
    ...
    def evaluate(self, keypoints_3d_predicted, split_by_subject=False, transfer_cmu_to_human36m=False,
        ...
        # mean error per 16/17 joints in mm, for each pose  对于每个姿势，每 16/17 个关节的平均误差（以 mm 为单位）
        ...
        per_pose_error_relative = np.sqrt(((keypoints_gt_relative - keypoints_3d_predicted_relative) ** 2).sum(2)).mean(
            1)
