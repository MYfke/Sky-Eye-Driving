...
from model.mvn.datasets.human36m import Human36MMultiViewDataset
...
while True:
    ...
    from model.mvn.utils.multiview import project_3d_points_to_image_plane_without_distortion as project
