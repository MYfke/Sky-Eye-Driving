...
def crop_image(image, bbox):
    """
    从指定为 bbox 的图像中裁剪区域。始终返回大小为 bbox 的区域，用零填充缺失的部分
...
def normalize_image(image):
    ...
    Returns:
        normalized_image numpy array of shape (h, w, 3): normalized image
    """
