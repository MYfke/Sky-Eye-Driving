...
from model.mvn.utils.img import image_batch_to_numpy, to_numpy, denormalize_image, resize_image
from model.mvn.utils.multiview import project_3d_points_to_image_plane_without_distortion

CONNECTIVITY_DICT = {
    'little_car': [(0, 2), (0, 9), (1, 0), (1, 17), (2, 12), (3, 0), (4, 3), (5, 4), (6, 2), (7, 6), (8, 7), (9, 10), (10, 11), (12, 13), (13, 14), (15, 1), (16, 15), (17, 18)],
...
def draw_2d_pose(keypoints, ax, kind='little_car', keypoints_mask=None, point_size=2, line_width=1, radius=None, color=None):
    """
    ...
    Args
        ...
        keypoints numpy 形状数组 (19, 2)：以 CMU 格式绘制的姿势。 ax: matplotlib 轴绘制
    """
